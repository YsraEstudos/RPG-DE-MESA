import { HumanBodyZone } from './components/HumanBodyZone'
import { FloatingButton } from './components/FloatingButton'
import { useLayoutStore } from './store/layoutStore'
import { Settings, PanelLeftClose, PanelLeftOpen, Move, X } from 'lucide-react'
...
function App() {
  ...
  // Sidebar logic is now handled in setActivePage to avoid double-renders (Layout Thrashing)
